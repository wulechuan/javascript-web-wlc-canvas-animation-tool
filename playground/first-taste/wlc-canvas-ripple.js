function setupRippleAnimation(animationController) {
	...
	var ripples = [
		new WlcCanvasRipple(canvas, waveOptions),
		new WlcCanvasRipple(canvas, waveOptions),
		new WlcCanvasRipple(canvas, waveOptions),
		new WlcCanvasRipple(canvas, waveOptions),
	];
	...
	function drawRipples(canvas, ctx, localTime) {
		for (var ripple of ripples) ripple.draw(localTime);
	}
...
function WlcCanvasRipple(canvas, initOptions) {
	this.canvas = canvas;
